...
/**
 * GET /api/admin/fakturoid-import/status?job_id=N
 *
 * Vrátí stav background importu spuštěného přes POST /api/admin/fakturoid-import
 * s dry_run=false.
 */
final class FakturoidImportStatusAction
{
